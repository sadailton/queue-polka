...
#include </home/vagrant/dr_pifo_simulation/utils/user_externs_RL_SP/RL_SP.h>
...
//std::vector<std::shared_ptr<bm::hier_scheduler::flow_scheduler>> bm::hier_scheduler::FS = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL}; // 3 levels
...
//std::vector<std::shared_ptr<bm::hier_scheduler::fifo_bank>> bm::hier_scheduler::FB = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL}; // 3 levels
...
//std::vector<unsigned int> bm::hier_scheduler::number_of_queues_per_level = {10,2,1}; // 3 levels
//std::vector<unsigned int> bm::hier_scheduler::number_of_queues_per_level = {16,8,4,2,1}; // 5 levels

std::vector<unsigned int> bm::hier_scheduler::number_of_pkts_per_queue_each_level = {5}; // one level
//std::vector<unsigned int> bm::hier_scheduler::number_of_pkts_per_queue_each_level = {5 ,bm::hier_scheduler::number_of_queues_per_level[0]}; // 2 levels
...
std::vector<unsigned int> bm::hier_scheduler::pred_each_queue = {125000,250000,125000,250000,125000};
std::vector<unsigned int> bm::hier_scheduler::WFQ_Q_weights = {3000,6000,9000,9000,3000};
int bm::hier_scheduler::pred_global_now = 0;
...
bm::hier_scheduler dequeue_scheduler; // create object of the bm::hier_scheduler class.
 public:
	struct buffer {
...
////////////////////// then the pop operation 
	...
	{
//	BMLOG_DEBUG("Invoked ELBEDIWY testing of starting the dequeue number_of_deq_pkts = {}, num_of_read_pkts = {}, number_of_enq_pkts = {}",dequeue_scheduler.number_of_deq_pkts(), dequeue_scheduler.num_of_read_pkts(), dequeue_scheduler.number_of_enq_pkts())
