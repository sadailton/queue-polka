...
//std::vector<std::shared_ptr<hier_scheduler::flow_scheduler>> hier_scheduler::FS = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL}; // 3 levels
...
//std::vector<std::shared_ptr<hier_scheduler::fifo_bank>> hier_scheduler::FB = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL}; // 3 levels
...
//std::vector<unsigned int> hier_scheduler::number_of_queues_per_level = {10,2,1}; // 3 levels
//std::vector<unsigned int> hier_scheduler::number_of_queues_per_level = {16,8,4,2,1}; // 5 levels

std::vector<unsigned int> hier_scheduler::number_of_pkts_per_queue_each_level = {5}; // one level
//std::vector<unsigned int> hier_scheduler::number_of_pkts_per_queue_each_level = {5 ,hier_scheduler::number_of_queues_per_level[0]}; // 2 levels
...
std::vector<unsigned int> hier_scheduler::pred_each_queue = {125000,250000,125000,250000,125000};
std::vector<unsigned int> hier_scheduler::WFQ_Q_weights = {3000,6000,9000,9000,3000};

int hier_scheduler::pred_global_now = 0;
