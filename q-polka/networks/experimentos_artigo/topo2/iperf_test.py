...
def run_iperf_client(host_name, port, bandwidth, duration):
    ip_h4 = "10.0.0.4"
...
def main():
    ...
    if hostname == "h1":
        run_iperf_client("h1", "5201", h1_bw, "420")

    elif hostname == "h2":
        run_iperf_client("h2", "5202", h2_bw, "330")

    elif hostname == "h3":
        run_iperf_client("h3", "5203", h3_bw, "240")
