...
std::vector<std::shared_ptr<hier_scheduler::flow_scheduler>> hier_scheduler::FS = {NULL}; // 2 levels
...
std::vector<std::shared_ptr<hier_scheduler::fifo_bank>> hier_scheduler::FB = { NULL}; // 2 levels
...
std::vector<unsigned int> hier_scheduler::number_of_pkts_per_queue_each_level = {2}; // one level
...
bool hier_scheduler::shaping = false;
...
*/
std::vector<unsigned int> hier_scheduler::quota_each_queue = {10500, 4500};
std::vector<unsigned int> hier_scheduler::quantums = {10500, 4500};

unsigned int hier_scheduler::active_queue = 0;
