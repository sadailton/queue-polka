...
class P4Switch(Switch):
    ...
    def __init__(self, name, json=None, debugger=False, loglevel="info",
        ...
        self.priority_queue_num = kwargs['priority_queue_num'] if 'priority_queue_num' in kwargs else None
  ...
  node: {nodeId}
    ...
    def bmv2Args(self):
        ...
        if not self.json:
            ...
            args.append("-- --load-modules=/home/p4/queue-polka/q-polka/networks/simple_dr_pifo/utils/user_externs_dr_pifo/DR_PIFO.so ")
        ...
        if self.priority_queue_num:
            args.append('--priority-queues %d' % self.priority_queue_num)
