...
# Author2: Adailton Saraiva
# Email: s.adailton@gmail.com
...
PROTOBUF_COMMIT="89c585602af7d28646ce92cd3abba07cfdad7fa6" #Aug 16 2025 - v32.0

# from https://github.com/p4lang/PI#dependencies
# changed it from 1.43.2 since pip does not have it and my source build fails
#GRPC_VER="1.44.0" #funciona
GRPC_VER="1.44.1"
#GRPC_COMMIT="tags/v${GRPC_VER}"
GRPC_COMMIT="208d6e73bd7e82aba5bdbe0e6a0eb4fa799b631e" # Feb 14 2023 - v1.44.1

PI_COMMIT="d28b31e4fa05b51f93b9810f5a3ef4a57fbfb8a8"    # May 18 2025 - sem numero de versão nessa data
BMV2_COMMIT="a1946fdbd901051f3f3bf4ded7cc71266f5ca1fc"  # Aug 12 2025 - v1.15.0
P4C_COMMIT="438db737dd8d37a6a49b581fbac4b597206fc182"   # Aug 11 2025 - v1.2.5.8

#FRROUTING_COMMIT="18f209926fb659790926b82dd4e30727311d22aa" # Mar 25 2021
#FRROUTING_COMMIT="frr-8.5" # Mar 25 2021
FRROUTING_COMMIT="frr-10.4.1" # Aug 1 2025
...
function do_global_setup {
    ...
    # upgrade pip3
    sudo pip3 install --upgrade pip==25.2
...
function do_protobuf {
    ...
    bazel build --enable_bzlmod :protoc :protobuf #--enable_workspace
...
function install_bazel {
    ...
    sudo apt-get update && sudo apt-get install -y bazel openjdk-8-jdk ruby
}
